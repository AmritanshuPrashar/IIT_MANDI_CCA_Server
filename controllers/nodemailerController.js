  ...
  try {
    const csvWriter = createObjectCsvWriter({
      ...
      header: [
        ...
        { id: 'humidity.internal.Sensor5', title: 'Internal Humidity Sensor 5' },
        { id: 'humidity.internal.Sensor6', title: 'Internal Humidity Sensor 6' },
        { id: 'humidity.internal.Sensor7', title: 'Internal Humidity Sensor 7' },
        { id: 'humidity.internal.Sensor8', title: 'Internal Humidity Sensor 8' },
        ...
        { id: 'humidity.external.Sensor4', title: 'External Humidity Sensor 4' },
        { id: 'humidity.external.Sensor5', title: 'External Humidity Sensor 5' },
        { id: 'humidity.external.Sensor6', title: 'External Humidity Sensor 6' },
        { id: 'humidity.external.Sensor7', title: 'External Humidity Sensor 7' },
        { id: 'humidity.external.Sensor8', title: 'External Humidity Sensor 8' },
        ...
        { id: 'soilTemperature.internal.Sensor5', title: 'Internal Soil Temperature Sensor 5' },
        { id: 'soilTemperature.internal.Sensor6', title: 'Internal Soil Temperature Sensor 6' },
        { id: 'soilTemperature.internal.Sensor7', title: 'Internal Soil Temperature Sensor 7' },
        { id: 'soilTemperature.internal.Sensor8', title: 'Internal Soil Temperature Sensor 8' },
    ...
    const csvData = data.map(item => ({
      ...
      'humidity.internal.Sensor5': item.data.humidity.internal.Sensor5,
      'humidity.internal.Sensor6': item.data.humidity.internal.Sensor6,
      'humidity.internal.Sensor7': item.data.humidity.internal.Sensor7,
      'humidity.internal.Sensor8': item.data.humidity.internal.Sensor8,
      ...
      'humidity.external.Sensor3': item.data.humidity.external.Sensor3,
      'humidity.external.Sensor4': item.data.humidity.external.Sensor4,
      'humidity.external.Sensor5': item.data.humidity.external.Sensor5,
      'humidity.external.Sensor6': item.data.humidity.external.Sensor6,
      'humidity.external.Sensor7': item.data.humidity.external.Sensor7,
      'humidity.external.Sensor8': item.data.humidity.external.Sensor8,
